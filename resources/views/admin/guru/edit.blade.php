        ...
        <form action="{{ route('guru.update', $guru) }}" method="POST">
            ...
            <div class="form-grid">
                <div class="form-group col-6">
                    ...
                    <input type="text" name="nip" id="nip" class="form-control" value="{{ old('nip', $guru->nip) }}" placeholder="18 digit NIP" maxlength="20" inputmode="numeric" oninput="this.value=this.value.replace(/\D/g,'')" required>
                </div>
