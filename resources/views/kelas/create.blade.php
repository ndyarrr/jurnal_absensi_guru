...
@section('content')
    ...
    <form action="{{ route('kelas.store') }}" method="POST">
        ...
        <label>Rombel (urutan kelas)</label><br>
        <input type="number" name="rombel" value="{{ old('rombel') }}" min="1" required><br><br>

        <label>Wali Kelas</label><br>
        <input type="text" name="wali_kelas" value="{{ old('wali_kelas') }}"><br><br>

        <label>Jumlah Siswa</label><br>
        <input type="number" name="jumlah_siswa" value="{{ old('jumlah_siswa') }}" min="0"><br><br>
